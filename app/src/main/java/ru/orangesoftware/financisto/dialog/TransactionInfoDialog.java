...
public class TransactionInfoDialog {
    ...
    public void show(Activity blotterActivity, long transactionId) {
    ...
    private void showDialog(final Activity blotterActivity, final long transactionId, final View v, View titleView) {
    ...
    private void add(LinearLayout layout, int labelId, String data, String pictureFileName) {
        Bitmap thumb = ThumbnailUtil.loadThumbnail(pictureFileName); //TODO: fix bug
