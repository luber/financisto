...
//    public static final String DROPBOX_AUTHORIZE = "dropbox_authorize";
	...
	public static boolean isRememberCategory(Context context) {
		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
		return sharedPreferences.getBoolean("remember_last_category", true);
	}
...
//    }
    ...
    public static boolean isHideClosedAccounts(Context context) {
        return getBoolean(context, "hide_closed_accounts", true);
    }
	...
	public static boolean isUseSmsParser(Context context) {
		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
		return sharedPreferences.getBoolean("is_use_sms_parser", true);
	}

	public static long getMainPrivatCardAccountId(Context context) {
		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
		String accountIdStr = sharedPreferences.getString("main_privatbank_card_account", "-1");
		return Long.parseLong(accountIdStr);
	}

	public static long getCacheAccountId(Context context) {
		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
		String accountIdStr = sharedPreferences.getString("cache_account", "-1");
		return Long.parseLong(accountIdStr);
	}

	public static long getSavingsAccountId(Context context) {
		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
		String accountIdStr = sharedPreferences.getString("savings_account", "-1");
		return Long.parseLong(accountIdStr);
	}

	public static long getAtmCommisionCategoryId(Context context) {
		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
		String categoryIdStr = sharedPreferences.getString("atm_commision_category", "-1");
		return Long.parseLong(categoryIdStr);
	}

	public static long getBankCommisionCategoryId(Context context) {
		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
		String categoryIdStr = sharedPreferences.getString("bank_commision_category", "-1");
		return Long.parseLong(categoryIdStr);
	}
