...
public class FlowzrSyncOptions {
    ...
    public FlowzrSyncOptions(String strUseCredential, long lastSyncLocalTimestamp,
//                             DefaultHttpClient pHttp_client,
                             String pRootFolderId,String _appVersion) {
...
//        this.http_client=pHttp_client;
    ...
    public static FlowzrSyncOptions fromPrefs(SharedPreferences preferences) {
        ...
        return new FlowzrSyncOptions(useCredential,lastSyncLocalTimestamp,rootFolderId,appVersion);
    }          		 		    	
