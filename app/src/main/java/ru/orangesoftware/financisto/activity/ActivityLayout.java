...
public class ActivityLayout {
	...
	private void selectSingleChoice(Context context, int titleId, final ListAdapter adapter, int checkedItem,
    ...
    private void selectSingleChoiceWithFilter(Context context, int titleId, final ListAdapter adapter, int checkedItem,
                                    DialogInterface.OnClickListener onClickListener) {
        ...
        editText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (filterableAdapter != null){
                    filterableAdapter.getFilter().filter(s);
                }
            }
    ...
    public void selectItemIdWithFilter(Context context, final int id, int titleId,
                             final ListAdapter adapter, int selectedPosition) {
        selectSingleChoiceWithFilter(context, titleId, adapter, selectedPosition,
                new DialogInterface.OnClickListener(){
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
