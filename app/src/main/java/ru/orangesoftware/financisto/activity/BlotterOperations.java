...
public class BlotterOperations {
    ...
    private static final int EDIT_TRANSACTION_REQUEST = 200;
	private static final int EDIT_TRANSFER_REQUEST = 400;
    ...
    public BlotterOperations(Activity activity, DatabaseAdapter db, long transactionId) {
