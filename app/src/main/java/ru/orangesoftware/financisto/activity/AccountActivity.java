...
//    private Cursor savingAccountsCursor;
	private TextView currencyText;
//	private TextView savingAccountText;
...
//	private CheckBox isUseSMSParser;
	...
	private ListAdapter savingAccountsAdapter;
...
//        isUseSMSParser = x.addCheckboxNode(layout,
//                R.id.is_use_sms_parser, R.string.is_use_sms_parser,
//                R.string.is_use_sms_parser_summary, false);
//
//        savingAccountsCursor = em.getAllActiveAccounts();
//        startManagingCursor(savingAccountsCursor);
//        savingAccountsAdapter = TransactionUtils.createAccountAdapter(this, savingAccountsCursor);
//        savingAccountText = x.addListNode(layout, R.id.savings_account, R.string.savings_account, R.string.savings_account_message);
//        setVisibility(savingAccountText, View.GONE);
...
//				account.isUseSMSParser = isUseSMSParser.isChecked();
	...
	protected void onClick(View v, int id) {
		switch(id) {
			case R.id.is_included_into_totals:
				...
				break;
//            case R.id.is_use_sms_parser:
//                isUseSMSParser.performClick();
//                setVisibility(savingAccountText, isUseSMSParser.isChecked()? View.VISIBLE : View.GONE);
//                break;
...
//                x.select(this, R.id.savings_account, R.string.savings_account, savingAccountsCursor, savingAccountsAdapter,
//                        "_id", account.savings_account_id);
//                break;
		}
	}
	...
	public void onSelectedId(int id, long selectedId) {
		switch(id) {
			case R.id.currency:
				...
				break;
//            case R.id.savings_account:
//                selectSavingAccount(selectedId);
//                break;
		}
	}
...
//    private void selectSavingAccount(long accountId) {
//        Account a = em.get(Account.class, accountId);
//        if (a != null) {
//            selectSavingAccount(a);
//        }
//    }

//    private void selectSavingAccount(Account a) {
//        savingAccountText.setText(a.title);
//        account.savings_account_id = a.id;
//        setVisibility(savingAccountText, isUseSMSParser.isChecked()? View.VISIBLE : View.GONE);
//    }
...
//        isUseSMSParser.setChecked(account.isUseSMSParser);
//        selectSavingAccount(account.savings_account_id);
