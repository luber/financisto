...
public class MyEntityManager extends EntityManager {
	...
	public Cursor getAllAccounts(boolean isActiveOnly, long... includeAccounts) {
		Query<Account> q = getAllAccountsQuery(isActiveOnly, includeAccounts);
		return q.execute();
	}

	public Query<Account> getAllAccountsQuery(boolean isActiveOnly, long... includeAccounts) {
